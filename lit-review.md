...
Conroy, John & O'leary, Dianne. (2001). Text summarization via hidden Markov models. 406-407. 10.1145/383952.384042. 
https://www.researchgate.net/publication/224890789_Text_summarization_via_hidden_Markov_models
...
Open question: how many sentences?
...
http://www.aclweb.org/anthology/W04-1017
Filatova, Elena, and Vasileios Hatzivassiloglou. "Event-based extractive summarization." Text Summarization Branches Out (2004).
...
http://www.aclweb.org/anthology/W97-0703 
...
Wong, Kam-Fai, Mingli Wu, and Wenjie Li. "Extractive summarization using supervised and semi-supervised learning." Proceedings of the 22nd International Conference on Computational Linguistics-Volume 1. Association for Computational Linguistics, 2008.
...
5.     Framework: 
a.     Ranki= RankPosi + RankLengthi
b.     Where RankPosiis the rank of sentence i according to its position in a document (i.e. the sentence no.) and RankLengthi is rank of sentence i according to its length. 
